...
source("C:\\Users\\Rachel\\Desktop\\SW\\final\\f_compute_survival_for_clone_SW_TV.R")
...
glm_formula_first <- (censor == 0) ~opening_clean_cf+age+parity+GWG+smoking+GBS.pos
glm_formula_rest <- (censor == 0) ~ ns(t, df =3) +opening_clean_cf +age+parity+GWG+smoking+GBS.pos
...
write.csv(cif_plot_df, "C:\\Users\\Rachel\\Desktop\\SW\\final\\results\\main\\cif_TV.csv", row.names = FALSE)
